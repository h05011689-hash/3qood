...
# الإعدادات
# ================================================================
API_TOKEN         = '8990468137:AAH7RscohGtG02YLWYVULw82HPQ7YgF9XGE'
...
def add_user_if_not_exists(uid, username, referrer=None):
    ...
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO users (id, username, balance, referred_by) VALUES (?,?,0.0,?)",
